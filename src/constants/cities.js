export const CITIES = {
  ...
  newyork: {
    ...
    waypoints: [
      ...
      { lat: 40.7, lng: -73.99, name: "Brooklyn Bridge" },
      { lat: 40.71, lng: -73.995, name: "Manhattan Bridge" },
      { lat: 40.712, lng: -73.965, name: "Williamsburg Bridge" },
      { lat: 40.7431, lng: -73.9541, name: "Pulaski Bridge" },
      { lat: 40.757, lng: -73.955, name: "Queensboro Bridge" },
      { lat: 40.762, lng: -73.968, name: "Central Park" },
    ],
    start: { lat: 40.706, lng: -74.0088, name: "Wall Street" },
    end: { lat: 40.762, lng: -73.968, name: "Central Park" },
  },
  tokyo: {
    name: "Tokyo (Bay View)",
